...
`com.gios.lightnotebook`. Current release: **v1.21.0**.
...
| --- | --- | --- |
| v1.21.0 | this commit | Shake the phone to report a glitch |
| v1.20.0 | `4dbffea` | Music runs alongside the day, and the planner knows where you were |
